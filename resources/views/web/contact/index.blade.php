                ...
                <div class="col-md-6">
                    <div class="contact-form">
                        ...
                        <form id="contact-form">
                            ...
                            <textarea class="input" name="body" placeholder="{{ __('web.msgInput') }}"></textarea>
                            <button id="contact-form-btn" type="submit"
                                class="main-button icon-button pull-right">{{ __('web.msgBtn') }}</button>
                        </form>
                    </div>
                </div>
                <!-- /contact form -->
...
@section('script')
    <script>
        ...
        $('#contact-form-btn').click(function(e) {
            $("#success-div").hide().empty();
            $("#errors-div").hide().empty();
            e.preventDefault();
