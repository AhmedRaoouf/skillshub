                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info edit-btn" data-toggle="modal"
                                                        data-id="{{ $cat->id }}" data-name-en="{{ $cat->name('en') }}"
                                                        data-name-ar="{{ $cat->name('ar') }}" data-target="#edit-modal">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <a class="btn btn-danger"
                                                        href="{{ url("dashboard/categories/delete/{$cat->id}") }}">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                    <a class="btn "
                                                        href="{{ url("dashboard/categories/toggle/{$cat->id}") }}">
                                                        @if ($cat->active)
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ url('dashboard/categories/store') }}" id="add">
                        @csrf
    ...
    <div class="modal fade" id="edit-modal" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ url('dashboard/categories/update') }}" id="edit">
                        @csrf
